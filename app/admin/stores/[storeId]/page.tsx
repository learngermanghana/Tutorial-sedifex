        ...
        <div className="space-y-6">
          <SectionCard title="Store operations">
            <div className="space-y-3 text-sm text-slate-600">
              <div className="rounded-2xl bg-slate-50 p-4">
                <div className="flex items-center gap-2 font-semibold text-slate-950"><PackageSearch className="h-4 w-4 text-indigo-600" /> Products</div>
                <p className="mt-2 leading-6">Next we can connect this card to the products collection for this store.</p>
              </div>
              <div className="rounded-2xl bg-slate-50 p-4">
                <div className="flex items-center gap-2 font-semibold text-slate-950"><ReceiptText className="h-4 w-4 text-indigo-600" /> Bookings and orders</div>
                <p className="mt-2 leading-6">Next we can show bookings, checkout status, and failed syncs for this store.</p>
              </div>
              <div className="rounded-2xl bg-slate-50 p-4">
                <div className="flex items-center gap-2 font-semibold text-slate-950"><Webhook className="h-4 w-4 text-indigo-600" /> Integrations</div>
                <p className="mt-2 leading-6">Review webhook clients, API access, and marketplace sync status here.</p>
              </div>
            </div>
          </SectionCard>
