...
function buildBigDealsSvg(product: PosterProduct, message: string) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}">
    ...
    <text x="560" y="865" text-anchor="middle" font-size="34" font-weight="900" fill="#fff">${escapeSvg(product.name)}</text><text x="725" y="965" text-anchor="middle" font-size="58" font-weight="950" fill="#fff">${escapeSvg(product.price || 'Shop now')}</text><text x="725" y="1016" text-anchor="middle" font-size="28" font-weight="800" fill="#fff7ed">${escapeSvg(message)}</text>
