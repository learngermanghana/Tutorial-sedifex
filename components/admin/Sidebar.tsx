...
import { Boxes, ChartNoAxesCombined, ChevronRight, Cog, CreditCard, House, Package, Plug, ShoppingBag, Store, Users, X } from 'lucide-react';
...
const groups: { label: string; items: Item[] }[] = [
  ...
  { label: 'Commerce', items: [{ href: '/admin/stores', label: 'Stores', icon: Store }, { href: '/admin/products', label: 'Products', icon: Package }, { href: '/admin/marketplace', label: 'Marketplace', icon: ShoppingBag }, { href: '/admin/checkout', label: 'Checkout', icon: CreditCard }] },
